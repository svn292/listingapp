    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Offstage(
            offstage:
                this.layout != 'list' || _utilitiesList.favoritesList.isEmpty,
          ...
          Offstage(
            offstage:
                this.layout != 'grid' || _utilitiesList.favoritesList.isEmpty,
            child: Container(
              ...
              child: new StaggeredGridView.countBuilder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  Utilitie utilitie =
                      _utilitiesList.favoritesList.elementAt(index);
