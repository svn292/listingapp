...
class CategoriesIconsContainerWidget extends StatefulWidget {
  CategoriesIconsContainerWidget({Key key, @required CategoriesList categoriesList, this.onPressed}) : super(key: key);
...
class _CategoriesIconsContainertState extends State<CategoriesIconsContainerWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Wrap(alignment: WrapAlignment.spaceBetween, children: _buildSuggestions(categoriesList.list, context)),
    );
  }
}
